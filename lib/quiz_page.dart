...
class _QuizePageState extends State<QuizPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // return Scaffold(
    //   appBar: AppBar(title: const Text("Synonym/Antonym Quiz")),
    //   body: Padding(
    //     padding: const EdgeInsets.all(16.0),
    //     child: Column(
    //       crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: const TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                        text: "/20", style: TextStyle(color: Colors.white38)),
                  ],
                ),
              ),
              const SizedBox(height: 12),
              ...
              const Text(
                "The graphs of the two linear equations\n"
                "a×b + b×y = c and b×x - a×y = c, where a, b and c are all not equal to zero.",
